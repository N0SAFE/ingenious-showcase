  ...
  return (
    <div className="mx-auto max-w-6xl px-6 py-20">
      ...
      <p className="mt-6 text-lg text-muted-foreground max-w-2xl">
        Chaque barre indique mon niveau relatif sur la compétence. Cliquez sur une compétence pour
        lire son article détaillé : définition, preuves, autocritique et évolution.
      </p>
